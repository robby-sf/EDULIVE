            ...
            <div class="flex flex-col md:flex-row items-center md:items-start text-center md:text-left gap-6">
                ...
                <div class="flex-grow w-full">
                    ...
                    <div class="mt-4 space-y-2">
                        ...
                        @endif
                        <p class="text-[#5E5E5E] text-sm flex items-center justify-center md:justify-start gap-2 font-light">
                             <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M2.003 5.884L10 2.086l7.997 3.798A2 2 0 0118 7.714v6.572a2 2 0 01-2 2H4a2 2 0 01-2-2V7.714a2 2 0 01-.003-1.83zM16 7.714l-6 2.857-6-2.857V14h12V7.714z" /></svg>
