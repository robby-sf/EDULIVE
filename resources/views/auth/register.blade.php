...
<body class="bg-neutral-950 font-poppins">
    <div class="w-full min-h-screen relative overflow-hidden flex items-center justify-center">
        ...
        <div
            class="w-[550px] bg-white/5 rounded-2xl border border-white/20 shadow-2xl backdrop-blur-xl p-10 relative fade-in-down">
            ...
            <div class="flex flex-col items-center pt-10">
                ...
                <form method="POST" action="{{ route('register') }}" class="w-full flex flex-col items-center">
                    ...
                    <div class="relative w-96 mb-6">
                        ...
                        <div class="absolute inset-y-0 right-0 flex items-center pr-4 cursor-pointer"
                            ...
                            <i id="eyeIcon2" class="fas fa-eye text-zinc-500 hover:text-white transition"></i>
                        </div>
                    </div>
                ...
                <p class="text-base font-light">
                    <span class="text-zinc-500">Already have account? </span>
